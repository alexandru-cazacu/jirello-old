defmodule JirelloWeb.Router do
  use JirelloWeb, :router

  import JirelloWeb.UserAuth
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: JirelloWeb.Telemetry
    end
  end
  ...
  scope "/", JirelloWeb do
    ...
    delete "/users/settings/:session_id", UserSettingsController, :delete
